metadata name = 'Revoke user session with incident trigger'
metadata description = 'This bicep deploys Sentinel playbook for revoking user sessions with incident trigger'
...
var LogicAppname = empty(servicePrefix) ? 'Revoke-UserSessions-Incident' : '${servicePrefix}-Revoke-UserSessions-Incident'
